                ...
                <form id="form-filter">
                    ...
                    <div class="col-md-3" >
                        <div class="form-group">
                            ...
                            <input type="text" name="jenis" value="" class="form-control" placeholder="jenis">
                        </div>
                    </div>
                    <div class="col-md-3" >
                        <div class="form-group">
...
<script>
    ...
    $(document).ready(function () {
        ...
        var id_outlet = $('select[name=outlet]').val();
        ...
        var table = $('#table-1').DataTable({
            'ajax': {
                'url': '<?= base_url() . $auth->get_url_controller() . 'datatables' ?>' + '?outlet=' + id_outlet,
