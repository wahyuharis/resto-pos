...
<?php echo form_open("", 'method="post" autocomplete="off" id="gcrud-search-form"'); ?>
                ...
                <?php if (!$unset_add) { ?>
                        <div class="floatL t5">
                            <a class="btn btn-primary" href="<?php if (isset($this->toro_add)) echo $this->toro_add;
                    else echo $add_url; ?>"><i class="fa fa-plus"></i> &nbsp; <?php echo $this->l('list_add'); ?> <?php echo $subject ?></a>
                        </div>
<?php } ?>
