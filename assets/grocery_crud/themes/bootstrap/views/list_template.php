...
<br/>
<div class="container-fluid gc-container" style="">
        ...
        <div class="table-section">
            ...
            <div class="table-container" style="border:none">
                ...
                <div class="header-tools" style="border:none">
                    <?php if (!$unset_add) { ?> 
                        <div class="floatL t5">
                            <a class="btn btn-primary" href="<?php if (isset($this->toro_add))
                        echo $this->toro_add;
                    else
                        echo $add_url;
                        ?>"><i class="fa fa-plus"></i> &nbsp; <?php echo $this->l('list_add'); ?> <?php echo $subject ?></a>
                        </div>
<?php } ?>
